...
sl_status_t sl_iostream_usart_init_mikroe(void)
{
  ...
  if (!uart_config_mikroe.sw_flow_control) {
    switch (SL_IOSTREAM_USART_MIKROE_FLOW_CONTROL_TYPE) 
    {
  ...
  sl_cos_config_vcom((uint32_t) SL_IOSTREAM_USART_MIKROE_BAUDRATE, flow_control);
