...
{
  0x73, 0x64, 0xf9, 0x25, 0xd1, 0x4d, 0x70, 0xb7, 0x82, 0x4f, 0x31, 0x3b, 0x57, 0x9c, 0xd0, 0xad, 
  0xcd, 0x4b, 0x29, 0xe0, 0x69, 0x11, 0x52, 0xb7, 0x54, 0x4c, 0x0d, 0x8e, 0x4a, 0x0e, 0xb6, 0xf0, 
  0x51, 0x38, 0xa0, 0x05, 0xd7, 0x05, 0xd4, 0xbf, 0xf9, 0x47, 0x2e, 0x8d, 0xd5, 0xb5, 0xdc, 0x6d, 
  0xc1, 0xa0, 0xfd, 0x4d, 0xaa, 0xef, 0x27, 0xbe, 0xbc, 0x4f, 0x1b, 0x16, 0xff, 0xc9, 0x86, 0x1b, 
  0xd1, 0xff, 0x8f, 0x77, 0x77, 0xd5, 0x1b, 0x97, 0xd4, 0x41, 0x1f, 0x72, 0xb5, 0x08, 0x05, 0xdf, 
  0xcd, 0x1b, 0xde, 0xda, 0x30, 0xbf, 0xf3, 0x93, 0x73, 0x48, 0x02, 0x27, 0x36, 0xb7, 0x17, 0x1b, 
  0xbd, 0x5f, 0x8a, 0xc2, 0x38, 0x28, 0xfa, 0x9d, 0xe1, 0x4f, 0x53, 0x90, 0x95, 0x04, 0x77, 0xf3, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_31) = {
  .len = 16,
  .data = { 0x1f, 0x4a, 0x5f, 0x91, 0x25, 0xfe, 0xa9, 0x87, 0x09, 0x42, 0x87, 0xd3, 0x52, 0x32, 0x39, 0x89, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_24) = {
  .len = 16,
  .data = { 0xc3, 0xd2, 0x88, 0x58, 0xbf, 0xb0, 0xf6, 0x8a, 0xb5, 0x45, 0xba, 0x18, 0xb4, 0x8d, 0xa0, 0xd7, }
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1a, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x1a, .char_uuid = 0x8000 } },
  ...
  { .handle = 0x1d, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x1a, .char_uuid = 0x8001 } },
  { .handle = 0x1e, .uuid = 0x8001, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_29 },
  { .handle = 0x1f, .uuid = 0x000d, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x02 } },
  ...
  { .handle = 0x23, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0a, .char_uuid = 0x8003 } },
  { .handle = 0x24, .uuid = 0x8003, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_35 },
  { .handle = 0x25, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0a, .char_uuid = 0x8004 } },
  { .handle = 0x26, .uuid = 0x8004, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_37 },
  { .handle = 0x27, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0a, .char_uuid = 0x8005 } },
  { .handle = 0x28, .uuid = 0x8005, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_39 },
  { .handle = 0x29, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0a, .char_uuid = 0x8006 } },
  { .handle = 0x2a, .uuid = 0x8006, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_41 },
  { .handle = 0x2b, .uuid = 0x0000, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_42 },
  { .handle = 0x2c, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x08, .char_uuid = 0x8007 } },
  { .handle = 0x2d, .uuid = 0x8007, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
};
